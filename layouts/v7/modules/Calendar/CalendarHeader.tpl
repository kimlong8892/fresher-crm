				...
				<div id="appnav" class="navbar-right">
					<ul class="nav navbar-nav">
						{if $IS_CREATE_PERMITTED}
							<li>
                                {* Modified by Hieu Nguyen on 2019-10-28 to split create event into 2 seperate buttons *}
								<button type="button" id="calendarview_basicaction_addevent" class="btn addButton btn-default module-buttons cursorPointer" onclick='Calendar_Calendar_Js.showCreateEventModal({ activityType: "Call" });'>
									<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;{vtranslate('LBL_ADD_CALL', $MODULE)}
								</button>
                                <button type="button" id="calendarview_basicaction_addevent" class="btn addButton btn-default module-buttons cursorPointer" onclick='Calendar_Calendar_Js.showCreateEventModal({ activityType: "Meeting" });'>
									<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;{vtranslate('LBL_ADD_MEETING', $MODULE)}
								</button>
                                {* End Hieu Nguyen *}
