        ...
        for (var index in selectedLineItemsData) {
            if (index != 0) {
                if (lineItemSelectedModuleName == 'Products') {
                    //-- Modified By Kelvin Thang -- on 2019-06-28 apply for multi select Products
                    jQuery(itemRow).closest('.lineItemTab').find('.addProduct').trigger('click', selectedLineItemsData[index]);
                } else if (lineItemSelectedModuleName == 'Services') {
                    //-- Modified By Kelvin Thang -- on 2019-06-28 apply for multi select Services
                    jQuery(itemRow).closest('.lineItemTab')('.addService').trigger('click', selectedLineItemsData[index]);
                }
            } else {
    ...
    registerEventForLineItemsSection: function() { 
        ...
        form.on("click", ".addSection", function(i) { 
            ...
            if (checkAddProduct > 0) {
                lineItemTabClone.find(".addProduct").trigger("click");
            } else {
                lineItemTabClone.find(".addService").trigger("click");
            }
        });
