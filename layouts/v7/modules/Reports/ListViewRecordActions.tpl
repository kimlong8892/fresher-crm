        ...
        {if $LISTVIEW_ENTRY->isEditableBySharing()}
            <span class="more dropdown action">
                ...
                <ul class="dropdown-menu">
                    <li><a data-id="{$LISTVIEW_ENTRY->getId()}" href="{$LISTVIEW_ENTRY->getEditViewUrl()}" name="editlink">{vtranslate('LBL_EDIT', $MODULE)}</a></li>   {* Modified by Hieu Nguyen on 2020-03-26 to make this button as direct link *}
