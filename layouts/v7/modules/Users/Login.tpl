...
{strip}
	<style>
		...
		.widgetHeight {
			height: 430px;  /* Modified by Hieu Nguyen to make the form fit with duplicate session error message */
    ...
    {if $smarty.session.check_captcha}
        {assign var="RECAPTCHA_CONFIG" value=getGlobalVariable('googleRecaptchaConfig')}
            ...
            jQuery(function ($) {
                $('form').find('button').on('click', function (e) {
                    if (grecaptcha.getResponse() == '') {
                        $('#validationMessage').removeClass('hide').text('Please check the captcha');
                        e.preventDefault();
                        return false;
                    }
                });
	...
	<div class="col-lg-12">
		...
		<div class="col-lg-6">
			<div class="loginDiv widgetHeight {if $smarty.session.check_captcha}hasCaptcha{/if}">  {* Modified by Hieu Nguyen on 2020-01-08 *}
                ...
                {* Modified by Hieu Nguyen to split login and forgot view *}
                    ...
                    <div id="loginFormDiv">
                        <form class="form-horizontal" method="POST" action="index.php">
                            ...
                            <div class="group">
                                ...
                                <a href="index.php?modules=Users&view=Login&tab=forgot" style="color: #15c;">forgot password?</a>
                            </div>
                        </form>
                    </div>
                {else}
                    <div id="forgotPasswordDiv">
                        <form class="form-horizontal" action="forgotPassword.php" method="POST">
                            ...
                            <div class="group">
                                ...
                                <span>Please enter details and submit<a href="index.php?modules=Users&view=Login" class="pull-right" style="color: #15c;">Back</a></span>
                            </div>
                        </form>
                    </div>
                {/if}
