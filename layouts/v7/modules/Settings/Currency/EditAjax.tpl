                    ...
                    <div class="row-fluid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls fieldValue col-xs-6">
                                ...
                                <input type="text" class="inputElement" name="conversion_rate" onkeyup="formatNumber(this, 'float')" data-rule-required="true" data-rule-greater_than_zero="true" placeholder="{vtranslate('LBL_ENTER_CONVERSION_RATE', $QUALIFIED_MODULE)}" value="{Vtiger_Currency_UIType::transformDisplayValue($RECORD_MODEL->get('conversion_rate'), null, true)}"/>
