...
{strip}
							...
							<div class="layoutBlockHeader row">
								...
								<div class="col-sm-9 padding10 marginLeftZero">
									<div class="blockActions" style="float:right !important;">
										...
										{if isDeveloperMode() && $BLOCK_MODEL->isAddCustomFieldEnabled() && $SELECTED_TAB eq 'editViewTab'}
		...
		<div class="layoutBlockHeader">
			...
			<div class="col-sm-9 padding10 marginLeftZero">
				<div class="blockActions" style="float: right !important;">
					...
					{if isDeveloperMode() && $SELECTED_TAB eq 'editViewTab'}
	...
	<div class="modal-dialog modal-content editBlockModal hide">
		{assign var=HEADER_TITLE value={vtranslate('LBL_EDIT_BLOCK', $QUALIFIED_MODULE)}} {include file="ModalHeader.tpl"|vtemplate_path:$MODULE
		TITLE=$HEADER_TITLE}
		<form class="form-horizontal editBlockForm">
