			...
			<form class="form-horizontal createCustomFieldForm">
				...
				<div class="modal-body model-body-scrollenabled">
					...
					<div class="form-group">
						...
						<div class="controls col-sm-7">
							<input type="text" class='inputElement col-sm-9' maxlength="50" {if $IS_FIELD_EDIT_MODE}disabled="disabled"{/if} name="fieldName" value="{vtranslate($FIELD_MODEL->get('name'), $SELECTED_MODULE_NAME)}" data-rule-required='true' style='width: 75%' />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label fieldLabel col-sm-5">
						...
						<div class="controls col-sm-7">
							<input type="text" class='inputElement col-sm-9' maxlength="50" name="fieldLabel" value="{$FIELD_MODEL->get('label')}" data-rule-required='true' style='width: 75%' {if $IS_FIELD_EDIT_MODE}readonly{/if}/>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label fieldLabel col-sm-5">
						...
						<div class="controls col-sm-7">
							<input type="text" class='inputElement col-sm-9' name="fieldLabelDisplayVn" value="{$FIELD_MODEL->labelDisplayVn}" data-rule-required='true' style='width: 75%' />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label fieldLabel col-sm-5">
						...
						<div class="controls col-sm-7">
							<input type="text" class='inputElement col-sm-9' name="fieldLabelDisplayEn" value="{$FIELD_MODEL->labelDisplayEn}" data-rule-required='true' style='width: 75%' />
						</div>
					</div>
					{* End Hieu Nguyen *}
