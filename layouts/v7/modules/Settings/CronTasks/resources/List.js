...
jQuery(function($) {
	...
	// Handle click event fo button Reset
	$('.btnReset').on('click', function() {
		if (!confirm(app.vtranslate('JS_RESET_CONFIRM_MSG'))) {
			return false;
		}
		...
		app.request.post({data: params}).then(function (err, data) {
			if (err === null) {
				var successMsg = app.vtranslate('JS_RESET_SUCCESS_MSG');
			...
			var errorMsg = app.vtranslate('JS_RESET_ERROR_MSG');
