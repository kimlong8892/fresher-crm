    ...
    <div class="table-actions">
        ...
        <span>
            {foreach item=RECORD_LINK from=$LISTVIEW_ENTRY->getRecordLinks()}
                ...
                &nbsp;
                <a class="btnReset" href="javascript:void(0)" data-record-id="{$LISTVIEW_ENTRY->getId()}">
                    <i class="fa fa-refresh" title="{vtranslate('LBL_BTN_RESET_TITLE', $QUALIFIED_MODULE)}"></i>
                </a>
