...
<div class="middle-block col-lg-8">
	...
	{* Summary View SMS History added by Phuc on 2020.02.18 *}
	{include file="layouts/v7/modules/SMSNotifier/SMSHistory.tpl"}
	{* Summary View SMS History Widget End Here *}
