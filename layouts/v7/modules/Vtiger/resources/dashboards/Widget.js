...
Vtiger_Widget_Js('Vtiger_TopPotentials_Widget_Js', {}, {
    ...
    postResizeWidget: function () {
		...
		var slimScrollDiv = container.find('.slimScrollDiv');
		var adjustedHeight = container.height() - 20;
...
Vtiger_Widget_Js('Vtiger_Custom_Widget_Js', 
    {},
    {
        postLoadWidget: function() {
            ...
            var widgetContent = jQuery('.dashboardWidgetContent', this.getContainer());
            var adjustedHeight = this.getContainer().height() - 40;
        ...
        postResizeWidget: function() {
            var widgetContent = jQuery('.dashboardWidgetContent', this.getContainer());
            var slimScrollDiv = jQuery('.slimScrollDiv', this.getContainer());
            var adjustedHeight = this.getContainer().height() - 80;
