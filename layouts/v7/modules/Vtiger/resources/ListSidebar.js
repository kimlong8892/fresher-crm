	...
	registerFilters: function() {
        ...
        filters.on('post.ToggleDefault.saved',function(e,params){
            ...
            if (params.isdefault === "1") {
                ...
                // Modified by Phu vo on 2019.09.03 to fix get wrong popover-content selector
                let popover = element.closest('.popover');
                popover.html(popover.find('.popover-content').html()).css('padding', '10px');
                // End Phu Vo
            }
