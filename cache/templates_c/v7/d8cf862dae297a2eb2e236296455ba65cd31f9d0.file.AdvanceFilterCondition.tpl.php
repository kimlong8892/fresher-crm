<?php /* Smarty version Smarty-3.1.7, created on 2021-01-14 11:35:45
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Vtiger/AdvanceFilterCondition.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20094605735fffca2157c4e0-36071333%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd8cf862dae297a2eb2e236296455ba65cd31f9d0' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Vtiger/AdvanceFilterCondition.tpl',
      1 => 1585899536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20094605735fffca2157c4e0-36071333',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fffca21770c9',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fffca21770c9')) {function content_5fffca21770c9($_smarty_tpl) {?>	
...
$_smarty_tpl->tpl_vars['FIELD_INFO']->value['value'] = decode_html($_smarty_tpl->tpl_vars['CONDITION_INFO']->value['value']);?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType()=='owner'&&$_smarty_tpl->tpl_vars['FIELD_INFO']->value['value']){?><?php $_smarty_tpl->createLocalArrayVariable('FIELD_INFO', null, 0);
$_smarty_tpl->tpl_vars['FIELD_INFO']->value['selected_tags'] = Vtiger_Owner_UIType::getSelectedOwnersFromOwnersString($_smarty_tpl->tpl_vars['FIELD_INFO']->value['value']);?><?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType()=='reference'&&in_array($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype'),array('52','77'))&&$_smarty_tpl->tpl_vars['FIELD_INFO']->value['value']){?><?php $_smarty_tpl->createLocalArrayVariable('FIELD_INFO', null, 0);
$_smarty_tpl->tpl_vars['FIELD_INFO']->value['selected_tags'] = Vtiger_Owner_UIType::getSelectedOwnersFromOwnersString($_smarty_tpl->tpl_vars['FIELD_INFO']->value['value']);?><?php }?>selected="selected"<?php }?><?php if (($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->get('name')=='Calendar'||$_smarty_tpl->tpl_vars['MODULE_MODEL']->value->get('name')=='Events')&&($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='recurringtype')){?><?php $_smarty_tpl->tpl_vars['PICKLIST_VALUES'] = new Smarty_variable(Calendar_Field_Model::getReccurencePicklistValues(), null, 0);?><?php $_smarty_tpl->createLocalArrayVariable('FIELD_INFO', null, 0);
