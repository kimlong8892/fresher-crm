<?php /* Smarty version Smarty-3.1.7, created on 2021-01-26 09:55:07
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Settings/ModuleManager/ListContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:847171210600f848be97cf5-11864558%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5bb2a178a7fe59b3ab827608902e8497bbda5c21' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Settings/ModuleManager/ListContents.tpl',
      1 => 1608711077,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '847171210600f848be97cf5-11864558',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_600f848c0c123',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_600f848c0c123')) {function content_600f848c0c123($_smarty_tpl) {?>


<script type="text/javascript" src="<?php echo vresource_url('layouts/v7/modules/Settings/ModuleManager/resources/ModuleBuilder.js');?>
"></script><div id="moduleBuilderModal" class="modal-dialog modal-content hide"><?php ob_start();?><?php echo vtranslate('LBL_MODULE_BUILDER_MODAL_TITLE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['HEADER_TITLE'] = new Smarty_variable($_tmp1, null, 0);?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("ModalHeader.tpl",$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('TITLE'=>$_smarty_tpl->tpl_vars['HEADER_TITLE']->value), 0);?>
<form class="form-horizontal moduleBuilderForm"><input type="hidden" name="blockid" /><div class="form-group"><label class="control-label fieldLabel col-sm-5"><span><?php echo vtranslate('LBL_MODULE_BUILDER_MODULE_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span>&nbsp;<span class="redColor">*</span></label><div class="controls col-sm-6"><input type="text" name="moduleName" class="col-sm-3 inputElement" data-rule-required='true' style='width: 75%' /></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-5"><span><?php echo vtranslate('LBL_MODULE_BUILDER_MODULE_DISPLAY_NAME_EN',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span>&nbsp;<span class="redColor">*</span></label><div class="controls col-sm-6"><input type="text" name="displayNameEn" class="col-sm-3 inputElement" data-rule-required='true' style='width: 75%' /></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-5"><span><?php echo vtranslate('LBL_MODULE_BUILDER_MODULE_DISPLAY_NAME_VN',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span>&nbsp;<span class="redColor">*</span></label><div class="controls col-sm-6"><input type="text" name="displayNameVn" class="col-sm-3 inputElement" data-rule-required='true' style='width: 75%' /></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-5"><span><?php echo vtranslate('LBL_MODULE_BUILDER_MODULE_MENU_GROUP',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span>&nbsp;<span class="redColor">*</span></label><div class="controls col-sm-6"><select name="menuGroup" class="col-sm-3 inputElement" data-rule-required='true' style='width: 75%'><?php $_smarty_tpl->tpl_vars['MENU_GROUPS'] = new Smarty_variable(Vtiger_MenuStructure_Model::getAppMenuList(), null, 0);?><?php  $_smarty_tpl->tpl_vars['GROUP_NAME'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['GROUP_NAME']->_loop = false;
...
$_smarty_tpl->tpl_vars['GROUP_NAME']->_loop = true;
 $_smarty_tpl->tpl_vars['INDEX']->value = $_smarty_tpl->tpl_vars['GROUP_NAME']->key;
?><option value="<?php echo $_smarty_tpl->tpl_vars['GROUP_NAME']->value;?>
"><?php echo vtranslate("LBL_".($_smarty_tpl->tpl_vars['GROUP_NAME']->value));?>
</option><?php } ?></select></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-5"><span><?php echo vtranslate('LBL_MODULE_BUILDER_MODULE_HAS_RELATED_ACTIVITIES_LIST',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span>&nbsp;</label><div class="controls col-sm-6"><input type="checkbox" value="1" checked onclick="$(this).attr('value', this.checked? 1 : 0);" name="hasActivities" class="col-sm-3 inputElement" style=" margin-top: 8px;"/></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-5"><span><?php echo vtranslate('LBL_MODULE_BUILDER_MODULE_IS_EXTENSION',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span>&nbsp;</label><div class="controls col-sm-6"><input type="checkbox" value="0" onclick="$(this).attr('value', this.checked? 1 : 0);" name="isExtension" class="col-sm-3 inputElement" style=" margin-top: 8px;"/></div></div><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('ModalFooter.tpl','Vtiger'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</form></div><div class="listViewPageDiv detailViewContainer" id="moduleManagerContents"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 "><div id="listview-actions" class="listview-actions-container"><div class="clearfix"><h4 class="pull-left"><?php echo vtranslate('LBL_MODULE_MANAGER',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</h4><?php if (isDeveloperMode()){?><div class="pull-right"><div class="btn-group"><button type="button" id="btnCreateModule" class="btn btn-primary"><?php echo vtranslate('LBL_MODULE_BUILDER_BTN_CREATE_NEW_MODULE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button></div>&nbsp;<div class="btn-group"><button class="btn btn-default" type="button" onclick='window.location.href="<?php echo $_smarty_tpl->tpl_vars['IMPORT_USER_MODULE_FROM_FILE_URL']->value;?>
...
</button></div></div><?php }?></div><br><div class="contents"><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><table class="table table-bordered modulesTable"><tr><?php  $_smarty_tpl->tpl_vars['MODULE_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['MODULE_MODEL']->_loop = false;
