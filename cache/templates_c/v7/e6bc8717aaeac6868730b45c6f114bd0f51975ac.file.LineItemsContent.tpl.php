<?php /* Smarty version Smarty-3.1.7, created on 2021-01-15 10:49:44
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:930793915600110d8a01bb5-73971340%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e6bc8717aaeac6868730b45c6f114bd0f51975ac' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsContent.tpl',
      1 => 1593395090,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '930793915600110d8a01bb5-73971340',
  'function' => 
  array (
  ),
  'variables' => 
...
$_smarty_tpl->tpl_vars['listPriceValues']->value[$_smarty_tpl->tpl_vars['currency_details']->value['currency_id']] = $_smarty_tpl->tpl_vars['currency_details']->value['conversionrate']*$_smarty_tpl->tpl_vars['purchaseCost']->value;?><?php } ?><?php }?><?php $_smarty_tpl->tpl_vars["sectionName"] = new Smarty_variable(("sectionName").($_smarty_tpl->tpl_vars['row_no']->value), null, 0);?><?php $_smarty_tpl->tpl_vars["sectionNum"] = new Smarty_variable(("sectionNum").($_smarty_tpl->tpl_vars['row_no']->value), null, 0);?><td style="text-align:center;"><i class="fa fa-trash deleteRow cursorPointer" title="<?php echo vtranslate('LBL_DELETE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
' height="42" width="42"></td><?php }?><!--Added by Kelvin Thang -- OnlineCRM -- 2018-09-17 --><input type="hidden" name="section_<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['section_no']->value;?>
"><?php if ($_smarty_tpl->tpl_vars['PRODUCT_EDITABLE']->value){?><td><!-- Product Re-Ordering Feature Code Addition Starts --><input type="hidden" name="hidtax_row_no<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
...
" style=" width: 90%; " class="lineItemCommentBox"><?php echo decode_html($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['comment']->value]);?>
</textarea></div><?php }?><?php }?></td><?php }?><td><!--Added by Kelvin Thang -- OnlineCRM -- Date: 2018-07-09 --><input id="<?php echo $_smarty_tpl->tpl_vars['qty']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars['qty']->value;?>
" type="text" onkeyup="formatNumber (this, 'float')" class="qty smallInputBox inputElement" style="width: 100% !important;"data-rule-required=true data-rule-currency=true data-rule-greater_than_zero=true value="<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value])){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value],null,true);?>
...
&nbsp;<span class="maxQuantity"><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qtyInStock']->value],null,true);?>
...
<?php }else{ ?>0<?php }?></span></td><?php }?><?php if ($_smarty_tpl->tpl_vars['LIST_PRICE_EDITABLE']->value){?><td><div><!--Added by Kelvin Thang -- OnlineCRM -- Date: 2018-07-09 --><input id="<?php echo $_smarty_tpl->tpl_vars['listPrice']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars['listPrice']->value;?>
" onkeyup="formatNumber (this, 'float')" value="<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['listPrice']->value])){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['listPrice']->value],null,true);?>
<?php }else{ ?>0<?php }?>" type="text"data-rule-required=true data-rule-currency=true class="listPrice smallInputBox inputElement " data-is-price-changed="<?php if ($_smarty_tpl->tpl_vars['RECORD_ID']->value&&$_smarty_tpl->tpl_vars['row_no']->value!=0){?>true<?php }else{ ?>false<?php }?>" list-info='<?php if (isset($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['listPrice']->value])){?><?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['listPriceValues']->value);?>
...
</span><?php }?></div><div style="clear:both"></div><?php if ($_smarty_tpl->tpl_vars['ITEM_DISCOUNT_AMOUNT_EDITABLE']->value||$_smarty_tpl->tpl_vars['ITEM_DISCOUNT_PERCENT_EDITABLE']->value){?><div><!-- Modified By Kelvin Thang -- OnlineCRM -- Date: 2018-07-09--><span>(-)&nbsp;<strong><a href="javascript:void(0)" class="inventoryLineItemEdits individualDiscount"><?php echo vtranslate('LBL_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
%)<?php }elseif($_smarty_tpl->tpl_vars['ITEM_DISCOUNT_AMOUNT_EDITABLE']->value&&$_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['discount_type']->value]=='amount'){?>(<?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['discount_amount']->value],null,true);?>
...
" class="discount_type" /><p class="popover_title hide"><?php echo vtranslate('LBL_SET_DISCOUNT_FOR',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 : <span class="variable"><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['productTotal']->value],null,true);?>
...
</td><td><!-- Added by Kelvin Thang -- OnlineCRM -- Date: 2018-07-23--><input type="text" data-rule-currency=true id="discount_amount<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" name="discount_amount<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" onkeyup="formatNumber(this)" value="<?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['discount_amount']->value],null,true);?>
...
"><p class="popover_title hide"><?php echo vtranslate('LBL_SET_TAX_FOR',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 : <span class="variable"><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['totalAfterDiscount']->value],null,true);?>
...
</td><td style="text-align: right;"><!--Added by Klevin Thang - Date: 2018-07-17--><input type="text" data-rule-positive=true data-rule-inventory_percentage=true  name="<?php echo $_smarty_tpl->tpl_vars['taxname']->value;?>
" id="<?php echo $_smarty_tpl->tpl_vars['taxname']->value;?>
" value="<?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['tax_data']->value['percentage'],null,true);?>
...
" value="<?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['tax_data']->value['amount'],null,true);?>
" readonly /></td></tr><?php } ?></table></div><?php }?></div></span></td><td><div id="productTotal<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" align="right" class="productTotal"><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['productTotal']->value]){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['productTotal']->value],null,true);?>
...
" align="right" class="discountTotal"><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['discountTotal']->value]){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['discountTotal']->value],null,true);?>
<?php }else{ ?>0<?php }?></div><div id="totalAfterDiscount<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" align="right" class="totalAfterDiscount"><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['totalAfterDiscount']->value]){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['totalAfterDiscount']->value],null,true);?>
<?php }else{ ?>0<?php }?></div><?php }?><div id="taxTotal<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" align="right" class="productTaxTotal <?php if ($_smarty_tpl->tpl_vars['IS_GROUP_TAX_TYPE']->value){?>hide<?php }?>"><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['taxTotal']->value]){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['taxTotal']->value],null,true);?>
<?php }else{ ?>0<?php }?></div></td><?php }?> <?php if ($_smarty_tpl->tpl_vars['MARGIN_EDITABLE']->value&&$_smarty_tpl->tpl_vars['PURCHASE_COST_EDITABLE']->value){?><td><input type="hidden" name="<?php echo $_smarty_tpl->tpl_vars['margin']->value;?>
" value="<?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['margin']->value]){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['margin']->value];?>
...
<?php }else{ ?>0<?php }?></span></td><?php }?><?php if ($_smarty_tpl->tpl_vars['LIST_PRICE_EDITABLE']->value){?> <td><span id="netPrice<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" class="pull-right netPrice"><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['netPrice']->value]){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['netPrice']->value],null,true);?>
