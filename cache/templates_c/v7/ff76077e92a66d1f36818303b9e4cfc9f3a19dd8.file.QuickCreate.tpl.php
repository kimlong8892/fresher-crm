<?php /* Smarty version Smarty-3.1.7, created on 2021-01-06 16:52:06
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Calendar/QuickCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13583405685ff58846cab8a9-64736348%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ff76077e92a66d1f36818303b9e4cfc9f3a19dd8' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Calendar/QuickCreate.tpl',
      1 => 1585899536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13583405685ff58846cab8a9-64736348',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ff58846ec2ed',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ff58846ec2ed')) {function content_5ff58846ec2ed($_smarty_tpl) {?>
...
&nbsp;<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()==true){?> <span class="redColor">*</span> <?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['isReferenceField']->value!="reference"){?></label><?php }?></td><td class="fieldValue <?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
 col-lg-9" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='19'){?> colspan="3" <?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?> <?php }?>> <?php if ($_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]&&$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]['customTemplate']){?><?php $_template = new Smarty_Internal_Template('eval:'.$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]['customTemplate'], $_smarty_tpl->smarty, $_smarty_tpl);echo $_template->fetch(); ?><?php }else{ ?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getUITypeModel()->getTemplateName(),$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }?></td><?php } ?></tr></table></div></div><div class="modal-footer"><center><?php if ($_smarty_tpl->tpl_vars['BUTTON_NAME']->value!=null){?><?php $_smarty_tpl->tpl_vars['BUTTON_LABEL'] = new Smarty_variable($_smarty_tpl->tpl_vars['BUTTON_NAME']->value, null, 0);?><?php }else{ ?><?php ob_start();?><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
