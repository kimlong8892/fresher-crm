<?php /* Smarty version Smarty-3.1.7, created on 2020-12-23 15:33:12
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Vtiger/uitypes/Currency.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18164366615fe300c80fbf20-37181757%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '052a59f5c5a819460078168ecef9ed79f738befd' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Vtiger/uitypes/Currency.tpl',
      1 => 1593395090,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18164366615fe300c80fbf20-37181757',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fe300c8194f5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fe300c8194f5')) {function content_5fe300c8194f5($_smarty_tpl) {?>
...
" type="text" class="inputElement currencyField" onkeyup="formatNumber (this, 'float')" maxlength="22" data-field-type="<?php echo $_smarty_tpl->tpl_vars['FIELD_INFO']->value['type'];?>
...
"  type="text" class="inputElement unitPrice currencyField" onkeyup="formatNumber (this, 'float')" maxlength="22" data-field-type="<?php echo $_smarty_tpl->tpl_vars['FIELD_INFO']->value['type'];?>
" name="<?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
...
</span><input type="text" class="input-lg currencyField" onkeyup="formatNumber (this, 'float')" maxlength="22" data-field-type="<?php echo $_smarty_tpl->tpl_vars['FIELD_INFO']->value['type'];?>
" name="<?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
"value="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getEditViewDisplayValue($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue'));?>
" <?php if (!empty($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value)){?>data-validator=<?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value);?>
<?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_INFO']->value["mandatory"]==true){?> data-rule-required="true" <?php }?> data-rule-currency='true'<?php if (count($_smarty_tpl->tpl_vars['FIELD_INFO']->value['validator'])){?>data-specific-rules='<?php echo ZEND_JSON::encode($_smarty_tpl->tpl_vars['FIELD_INFO']->value["validator"]);?>
