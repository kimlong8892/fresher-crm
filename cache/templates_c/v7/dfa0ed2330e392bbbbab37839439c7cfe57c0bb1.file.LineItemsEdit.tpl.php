<?php /* Smarty version Smarty-3.1.7, created on 2021-01-15 10:49:44
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1496711804600110d8423a21-28730473%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dfa0ed2330e392bbbbab37839439c7cfe57c0bb1' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsEdit.tpl',
      1 => 1593395090,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1496711804600110d8423a21-28730473',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'BLOCK_LABEL' => 0,
    'MODULE' => 0,
    'COMBO_PRODUCTS_IGNORE_MODULES' => 0,
    'COMBO_PRODUCTS' => 0,
    'CP_TEMPLATE_INFO' => 0,
...
" /><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['SELECTED_CURRENCY']->value['currency_id'];?>
" id="selectedCurrencyId" /></center></div><div class="col-lg-3 col-md-3 col-sm-3" style="top: 3px;"><div style="float: right;"><i class="fa fa-info-circle"></i>&nbsp;<label><?php echo vtranslate('LBL_TAX_MODE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</option></select></div></div></div><!--Added by Kelvin Thang -- OnlineCRM -- 2018-09-10 --><div class="lineitemTableContainer"><?php  $_smarty_tpl->tpl_vars['RELATED_PRODUCTS_SECTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['RELATED_PRODUCTS_SECTION']->_loop = false;
 $_smarty_tpl->tpl_vars['section_no'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['RELATED_PRODUCTS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['RELATED_PRODUCTS_SECTION']->key => $_smarty_tpl->tpl_vars['RELATED_PRODUCTS_SECTION']->value){
$_smarty_tpl->tpl_vars['RELATED_PRODUCTS_SECTION']->_loop = true;
 $_smarty_tpl->tpl_vars['section_no']->value = $_smarty_tpl->tpl_vars['RELATED_PRODUCTS_SECTION']->key;
?><div class="lineItemTab"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/lineItemTabContent.tpl",'Inventory'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('section_no'=>$_smarty_tpl->tpl_vars['section_no']->value,'data'=>$_smarty_tpl->tpl_vars['RELATED_PRODUCTS_SECTION']->value,'IGNORE_UI_REGISTRATION'=>true), 0);?>
</div><?php } ?><?php if (count($_smarty_tpl->tpl_vars['RELATED_PRODUCTS']->value)==0&&($_smarty_tpl->tpl_vars['PRODUCT_ACTIVE']->value=='true'||$_smarty_tpl->tpl_vars['SERVICE_ACTIVE']->value=='true')){?><div class="lineItemTab"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/lineItemTabContent.tpl",'Inventory'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('section_no'=>0,'row_no'=>1,'create'=>1,'data'=>array(),'IGNORE_UI_REGISTRATION'=>true), 0);?>
</div><?php }?></div><br><div class="btn-group"><button type="button" class="btn btn-default addSection" id="addSection" data-module-name="Products"><i class="fa fa-plus" style="margin-right: 5px;"></i><strong><?php echo vtranslate('LBL_ADD_SECTION',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button></div></div><!--Added by Kelvin Thang -- OnlineCRM -- 2018-09-10 --><div class="lineItemTabCloneCopy hide"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/lineItemTabContent.tpl",'Inventory'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('template'=>1,'section_no'=>0,'data'=>array(),'RELATED_PRODUCTS_SECTION'=>array(),'IGNORE_UI_REGISTRATION'=>true), 0);?>
</div><!--<br><div><div><?php if ($_smarty_tpl->tpl_vars['PRODUCT_ACTIVE']->value=='true'&&$_smarty_tpl->tpl_vars['SERVICE_ACTIVE']->value=='true'){?><div class="btn-toolbar"><span class="btn-group"><button type="button" class="btn btn-default" id="addProduct" data-module-name="Products" ><i class="fa fa-plus"></i>&nbsp;&nbsp;<strong><?php echo vtranslate('LBL_ADD_PRODUCT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></button></div><?php }?></div></div>--><br><div class="fieldBlockContainer"><table class="table table-bordered blockContainer lineItemTable" id="lineItemResult"><tr><td width="83%"><!-- Modified by Kelvin Thang -- OnlineCRM -- Date: 2018-07-10--><div class="pull-right fieldTotal"><strong><?php echo vtranslate('LBL_ITEMS_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></div></td><td><div id="netTotal" class="pull-right netTotal fieldTotal"><?php if (!empty($_smarty_tpl->tpl_vars['FINAL']->value['hdnSubTotal'])){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['FINAL']->value['hdnSubTotal'],null,true);?>
<?php }else{ ?>0<?php }?></div></td></tr><?php if ($_smarty_tpl->tpl_vars['DISCOUNT_AMOUNT_EDITABLE']->value||$_smarty_tpl->tpl_vars['DISCOUNT_PERCENT_EDITABLE']->value){?><tr><td width="83%"><span class="pull-right">(-)&nbsp;<strong><!-- Modified By Kelvin Thang -- OnlineCRM -- Date: 2018-07-09--><a class="inventoryLineItemEdits" href="javascript:void(0)" id="finalDiscount"><?php echo vtranslate('LBL_OVERALL_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
%)<?php }elseif($_smarty_tpl->tpl_vars['DISCOUNT_AMOUNT_EDITABLE']->value&&$_smarty_tpl->tpl_vars['FINAL']->value['discount_type_final']=='amount'){?>(<?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['FINAL']->value['discount_amount_final'],null,true);?>
)<?php }else{ ?>(0)<?php }?></span></a></strong></span></td><td><!--Added by Kelvin Thang -- OnlineCRM - Date: 2018-07-23--><span id="discountTotal_final" class="pull-right discountTotal_final"><?php if ($_smarty_tpl->tpl_vars['FINAL']->value['discountTotal_final']){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['FINAL']->value['discountTotal_final'],null,true);?>
...
" /><p class="popover_title hide"><?php echo vtranslate('LBL_SET_DISCOUNT_FOR',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 : <span class="subTotalVal"><?php if (!empty($_smarty_tpl->tpl_vars['FINAL']->value['hdnSubTotal'])){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['FINAL']->value['hdnSubTotal'],null,true);?>
...
</td><!-- Modified By Kelvin Thang -- OnlineCRM -- Date: 2018-07-13--><td><input type="text" data-rule-currency=true onkeyup="formatNumber(this)" id="discount_amount_final" name="discount_amount_final" value="<?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['FINAL']->value['discount_amount_final'],null,true);?>
" class="span1 pull-right discount_amount_final discountVal <?php if ($_smarty_tpl->tpl_vars['DISCOUNT_TYPE_FINAL']->value!='amount'){?>hide<?php }?>" /></td></tr><?php }?></tbody></table></div><!-- End Popup Div --></td></tr><?php }?><?php if ($_smarty_tpl->tpl_vars['SH_PERCENT_EDITABLE']->value){?><?php $_smarty_tpl->tpl_vars['CHARGE_AND_CHARGETAX_VALUES'] = new Smarty_variable($_smarty_tpl->tpl_vars['FINAL']->value['chargesAndItsTaxes'], null, 0);?><tr><td width="83%"><!-- Modified By Kelvin Thang -- Date: 2018-07-09--><span class="pull-right">(+)&nbsp;<strong><a class="inventoryLineItemEdits" href="javascript:void(0)" id="charges"><?php echo vtranslate('LBL_CHARGES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</td><!-- Modified By Kelvin Thang -- Date: 2018-07-13--><td class="lineOnTop"><?php if ($_smarty_tpl->tpl_vars['CHARGE_MODEL']->value->get('format')=='Percent'){?><input type="text" class="span1 chargePercent" size="5" data-rule-currency=true onkeyup="formatNumber(this)" data-rule-inventory_percentage=true name="charges[<?php echo $_smarty_tpl->tpl_vars['CHARGE_ID']->value;?>
...
<?php }?>" />&nbsp;%<?php }?></td><!-- Modified By Kelvin Thang -- Date: 2018-07-13--><td style="text-align: right;" class="lineOnTop"><!--<input type="text" class="span1 chargeValue" size="5" <?php if ($_smarty_tpl->tpl_vars['CHARGE_MODEL']->value->get('format')=='Percent'){?>readonly<?php }?> data-rule-currency=true onkeyup="formatNumber(this)" name="charges[<?php echo $_smarty_tpl->tpl_vars['CHARGE_ID']->value;?>
...
<?php }?>" />&nbsp;--><input type="text" class="span1 chargeValue" size="5" <?php if ($_smarty_tpl->tpl_vars['CHARGE_MODEL']->value->get('format')=='Percent'){?>readonly<?php }?> data-rule-currency=true onkeyup="formatNumber(this)" name="charges[<?php echo $_smarty_tpl->tpl_vars['CHARGE_ID']->value;?>
][value]" value="<?php if ($_smarty_tpl->tpl_vars['CHARGE_VALUE']->value){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['CHARGE_VALUE']->value,null,true);?>
<?php }elseif($_smarty_tpl->tpl_vars['RECORD_ID']->value){?>0<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['CHARGE_MODEL']->value->getValue()*$_smarty_tpl->tpl_vars['USER_MODEL']->value->get('conv_rate');?>
<?php }?>" />&nbsp;<!--<input type="text" class="span1 chargeValue" size="5" <?php if ($_smarty_tpl->tpl_vars['CHARGE_MODEL']->value->get('format')=='Percent'){?>readonly<?php }?> data-rule-currency=true onkeyup="formatNumber(this)" name="charges[<?php echo $_smarty_tpl->tpl_vars['CHARGE_ID']->value;?>
][value]" value="<?php if ($_smarty_tpl->tpl_vars['CHARGE_VALUE']->value){?><?php echo $_smarty_tpl->tpl_vars['CHARGE_VALUE']->value;?>
<?php }elseif($_smarty_tpl->tpl_vars['RECORD_ID']->value){?>0<?php }else{ ?><?php echo Vtiger_Currency_UIType::transformDisplayValue(($_smarty_tpl->tpl_vars['CHARGE_MODEL']->value->getValue()*$_smarty_tpl->tpl_vars['USER_MODEL']->value->get('conv_rate')),null,true);?>
...
<?php }else{ ?>0<?php }?></span></td></tr><?php }?><tr><td width="83%"><span class="pull-right fieldTotal" ><strong><?php echo vtranslate('LBL_PRE_TAX_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></span></td><td><?php $_smarty_tpl->tpl_vars['PRE_TAX_TOTAL'] = new Smarty_variable($_smarty_tpl->tpl_vars['FINAL']->value['preTaxTotal'], null, 0);?><span class="pull-right fieldTotal" id="preTaxTotal"><?php if ($_smarty_tpl->tpl_vars['PRE_TAX_TOTAL']->value){?><?php echo $_smarty_tpl->tpl_vars['PRE_TAX_TOTAL']->value;?>
...
<?php }else{ ?>0<?php }?>"/></td></tr><!-- Group Tax - starts --><tr id="group_tax_row" valign="top" class="<?php if ($_smarty_tpl->tpl_vars['IS_INDIVIDUAL_TAX_TYPE']->value){?>hide<?php }?>"><td width="83%"><span class="pull-right"><!-- Modified By Kelvin Thang -- Date: 2018-07-09-->(+)&nbsp;<strong><a class="inventoryLineItemEdits" href="javascript:void(0)" id="finalTax"><?php echo vtranslate('LBL_TAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" style="cursor:pointer;" value="<?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['tax_detail']->value['amount'],null,true);?>
...
" /></table></div><!-- End Popup Div Group Tax --></td><td><span id="tax_final" class="pull-right tax_final"><?php if ($_smarty_tpl->tpl_vars['FINAL']->value['tax_totalamount']){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['FINAL']->value['tax_totalamount'],null,true);?>
<?php }else{ ?>0<?php }?></span></td></tr><!-- Group Tax - ends --><?php if ($_smarty_tpl->tpl_vars['SH_PERCENT_EDITABLE']->value){?><tr><td width="83%"><!-- Modified By Kelvin Thang -- Date: 2018-07-09--><span class="pull-right">(+)&nbsp;<strong><a class="inventoryLineItemEdits" href="javascript:void(0)" id="chargeTaxes"><?php echo vtranslate('LBL_TAXES_ON_CHARGES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?></span></td></tr><!--<tr><td width="83%"><span class="pull-right">(-)&nbsp;<strong><a class="inventoryLineItemEdits" href="javascript:void(0)" id="deductTaxes"><?php echo vtranslate('LBL_DEDUCTED_TAXES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
&nbsp;&nbsp;</strong>--><span><?php echo vtranslate('LBL_ADJUSTMENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;&nbsp;</span><span><!-- Modified By Kelvin Thang -- Date: 2018-07-07--><input type="radio" name="adjustmentType" option value="+" <?php if ($_smarty_tpl->tpl_vars['FINAL']->value['adjustment']>=0){?>checked<?php }?>>&nbsp;<?php echo vtranslate('LBL_PLUS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</span></div></td><!-- Modified by Kelvin Thang -- Date: 2018-07-13--><td><span class="pull-right"><input id="adjustment" name="adjustment" style="width: 110px !important;" type="text" onkeyup="formatNumber(this)" data-rule-currency="true" class="lineItemInputBox form-control 00"value="<?php if ($_smarty_tpl->tpl_vars['FINAL']->value['adjustment']<0){?><?php echo Vtiger_Currency_UIType::transformDisplayValue(abs($_smarty_tpl->tpl_vars['FINAL']->value['adjustment']),null,true);?>
<?php }elseif($_smarty_tpl->tpl_vars['FINAL']->value['adjustment']){?><?php ob_start();?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['FINAL']->value['adjustment'],null,true);?>
<?php $_tmp2=ob_get_clean();?><?php echo $_tmp2;?>
<?php }else{ ?>0<?php }?>"><!--value="<?php if ($_smarty_tpl->tpl_vars['FINAL']->value['adjustment']<0){?><?php echo abs($_smarty_tpl->tpl_vars['FINAL']->value['adjustment']);?>
<?php }elseif($_smarty_tpl->tpl_vars['FINAL']->value['adjustment']){?><?php echo Vtiger_Currency_UIType::transformDisplayValue($_smarty_tpl->tpl_vars['FINAL']->value['adjustment'],null,true);?>
<?php }else{ ?>0<?php }?>"><input id="adjustment" name="adjustment" type="text" data-rule-positive="true" class="lineItemInputBox form-control" value="<?php if ($_smarty_tpl->tpl_vars['FINAL']->value['adjustment']<0){?><?php echo abs($_smarty_tpl->tpl_vars['FINAL']->value['adjustment']);?>
<?php }elseif($_smarty_tpl->tpl_vars['FINAL']->value['adjustment']){?><?php echo $_smarty_tpl->tpl_vars['FINAL']->value['adjustment'];?>
<?php }else{ ?>0<?php }?>">--></span></td></tr><tr valign="top"><td width="83%"><span class="pull-right fieldTotal"><strong><?php echo vtranslate('LBL_GRAND_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></span></td><td  style="background-color: yellow;" ><span id="grandTotal" name="grandTotal" class="pull-right grandTotal fieldTotal"><?php echo $_smarty_tpl->tpl_vars['FINAL']->value['grandTotal'];?>
</span></td></tr><!--<?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='PurchaseOrder'){?><tr valign="top"><td width="83%" ><div class="pull-right"><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Invoice'){?><strong><?php echo vtranslate('LBL_RECEIVED',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong><?php }else{ ?><strong><?php echo vtranslate('LBL_PAID',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong><?php }?></div></td><td><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Invoice'){?><span class="pull-right"><input id="received" name="received" onkeyup="formatNumber(this)" type="text" class="lineItemInputBox form-control" value="<?php if ($_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('received')&&!($_smarty_tpl->tpl_vars['IS_DUPLICATE']->value)){?><?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('received');?>
<?php }else{ ?>0<?php }?>"></span><?php }else{ ?><span class="pull-right"><input id="paid" name="paid" onkeyup="formatNumber(this)" type="text" class="lineItemInputBox" value="<?php if ($_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('paid')&&!($_smarty_tpl->tpl_vars['IS_DUPLICATE']->value)){?><?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('paid');?>
