<?php /* Smarty version Smarty-3.1.7, created on 2021-01-26 09:54:54
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Vtiger/Header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1187943656600f847f001d09-37486070%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3bbd7d96df7367f82d378a8041d0237cb148e0c8' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Vtiger/Header.tpl',
      1 => 1608711077,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1187943656600f847f001d09-37486070',
  'function' => 
  array (
  ),
  'variables' => 
...
" /><?php } ?><link type="text/css" rel="stylesheet" href="layouts/v7/resources/font.css" media="screen" /> <link type="text/css" rel="stylesheet" href="layouts/v7/resources/custom.css" media="screen" /><style type="text/css">@media print {.noprint { display:none; }}</style><script type="text/javascript">var __pageCreationTime = (new Date()).getTime();</script><script src="<?php echo vresource_url('layouts/v7/lib/jquery/jquery.min.js');?>
"></script><script src="<?php echo vresource_url('layouts/v7/lib/jquery/jquery-migrate-1.0.0.js');?>
"></script><?php if ($_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('id')){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("HeaderScripts.tpl",$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }?><script type="text/javascript">var _META = { 'module': "<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
"};<?php }?></script></head><body data-skinpath="<?php echo Vtiger_Theme::getBaseThemePath();?>
