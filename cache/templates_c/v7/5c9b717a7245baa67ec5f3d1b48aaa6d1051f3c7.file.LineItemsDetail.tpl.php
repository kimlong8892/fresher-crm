<?php /* Smarty version Smarty-3.1.7, created on 2021-01-06 17:01:28
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Inventory/LineItemsDetail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6008310865ff58a784af4b1-43231273%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5c9b717a7245baa67ec5f3d1b48aaa6d1051f3c7' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Inventory/LineItemsDetail.tpl',
      1 => 1593395090,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6008310865ff58a784af4b1-43231273',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ff58a788fd62',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ff58a788fd62')) {function content_5ff58a788fd62($_smarty_tpl) {?>
...
<?php $_smarty_tpl->tpl_vars['FINAL_DETAILS'] = new Smarty_variable($_smarty_tpl->tpl_vars['RELATED_PRODUCTS']->value[1][1]['final_details'], null, 0);?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['REGION_LABEL'] = new Smarty_variable($_tmp1." : ".($_smarty_tpl->tpl_vars['TAX_REGION_MODEL']->value->getName()), null, 0);?>
                ...
                <div class="lineItemBlockHeader pull-right" style=" margin-right: 16px;">
                    ...
                    <strong><?php echo vtranslate('LBL_CURRENCY',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
 :</strong> <?php echo vtranslate($_smarty_tpl->tpl_vars['CURRENCY_INFO']->value['currency_name'],$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
(<?php echo $_smarty_tpl->tpl_vars['CURRENCY_INFO']->value['currency_symbol'];?>
)
                </div>

                <div class="lineItemBlockHeader pull-right " style=" margin-right: 16px;">
                    <strong><?php echo vtranslate('LBL_TAX_MODE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
 :</strong> <?php echo vtranslate($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['taxtype'],$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
        ...
        <div class="blockData">
            ...
            <?php  $_smarty_tpl->tpl_vars['RELATED_PRODUCTS_SECTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['RELATED_PRODUCTS_SECTION']->_loop = false;
...
?>
                <div class="lineItemsTable">
                    <table class="table table-bordered " width="100%">
                        <tbody>
                            <?php if (count($_smarty_tpl->tpl_vars['RELATED_PRODUCTS']->value)!=1){?>
                                <tr>
                                    <td colspan="5">
                                        <?php $_smarty_tpl->tpl_vars['sectionNumTabName'] = new Smarty_variable(array_column($_smarty_tpl->tpl_vars['RELATED_PRODUCTS_SECTION']->value,'sectionNumTabName'), null, 0);?>
                                        <strong><span><?php echo vtranslate('LBL_SECTION_NAME',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span></strong> :
                                        <strong><span><?php echo $_smarty_tpl->tpl_vars['sectionNumTabName']->value[0];?>
</span></strong>
...
<?php $_tmp2=ob_get_clean();?><?php echo vtranslate($_tmp2,$_smarty_tpl->tpl_vars['MODULE']->value);?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['PRODUCT_VIEWABLE']->value){?>
                                    <td class="lineItemFieldName" width="25%">
                                        <strong><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['LINEITEM_FIELDS']->value['productid']->get('label');?>
...
<?php $_tmp7=ob_get_clean();?><?php echo vtranslate($_tmp7,$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['LIST_PRICE_EDITABLE']->value){?> 
                                    <td class="lineItemFieldName" width="10%">
...
"><?php echo vtranslate('LBL_TAX',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['MARGIN_VIEWABLE']->value){?>
                                        <td>
                                            <div align = "right"><?php echo $_smarty_tpl->tpl_vars['LINE_ITEM_DETAIL']->value["margin".($_smarty_tpl->tpl_vars['INDEX']->value)];?>
</div>
                                        </td>
                                    <?php }?>
        ...
        <tr>
            <td width="83%">
                <div align="right">
                    ...
                    <?php echo vtranslate('LBL_ADJUSTMENT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
