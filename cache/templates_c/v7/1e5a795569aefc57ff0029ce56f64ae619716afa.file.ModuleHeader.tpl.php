<?php /* Smarty version Smarty-3.1.7, created on 2021-01-26 09:54:55
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Vtiger/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:284381008600f847f66f6d0-17286741%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1e5a795569aefc57ff0029ce56f64ae619716afa' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Vtiger/ModuleHeader.tpl',
      1 => 1585899536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '284381008600f847f66f6d0-17286741',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_600f847f78214',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_600f847f78214')) {function content_600f847f78214($_smarty_tpl) {?>
...
">&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
 &nbsp;&nbsp;</a></p><?php }?><?php $_smarty_tpl->tpl_vars['TITLE'] = new Smarty_variable(vtranslate(strtoupper("LBL_VIEW_".($_REQUEST['view'])."_TITLE"),$_smarty_tpl->tpl_vars['MODULE']->value), null, 0);?><?php if ($_smarty_tpl->tpl_vars['TITLE']->value&&strpos($_smarty_tpl->tpl_vars['TITLE']->value,'LBL')===false){?><p class="current-filter-name filter-name pull-left"><span class="fa fa-angle-right pull-left" aria-hidden="true"></span><a title="<?php echo $_smarty_tpl->tpl_vars['TITLE']->value;?>
...
&nbsp; <span class="caret"></span></button><ul class="detailViewSetting dropdown-menu"><!--Modified by Kelvin Thang - OnlineCRM --><?php  $_smarty_tpl->tpl_vars['SETTING'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['SETTING']->_loop = false;
...
> <?php echo vtranslate($_smarty_tpl->tpl_vars['SETTING']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
