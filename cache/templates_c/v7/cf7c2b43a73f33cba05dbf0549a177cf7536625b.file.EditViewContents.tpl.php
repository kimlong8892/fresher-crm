<?php /* Smarty version Smarty-3.1.7, created on 2021-01-15 10:49:43
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Inventory/partials/EditViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1288225025600110d7f25582-87056516%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cf7c2b43a73f33cba05dbf0549a177cf7536625b' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Inventory/partials/EditViewContents.tpl',
      1 => 1585899536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1288225025600110d7f25582-87056516',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_600110d81a80c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_600110d81a80c')) {function content_600110d81a80c($_smarty_tpl) {?>
...
</h4><hr><table class="table table-borderless <?php if ($_smarty_tpl->tpl_vars['BLOCK_LABEL']->value=='LBL_ADDRESS_INFORMATION'){?> addressBlock<?php }?>"><?php if (($_smarty_tpl->tpl_vars['BLOCK_LABEL']->value=='LBL_ADDRESS_INFORMATION')&&($_smarty_tpl->tpl_vars['MODULE']->value!='PurchaseOrder')){?><!--Modified By Kelvin Thang -- Date: 2018-07-10--><tr><td class="fieldLabel " name="copyHeader1"><label  name="togglingHeader"><?php echo vtranslate('LBL_BILLING_ADDRESS_FROM',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></td><td class="fieldValue" name="copyAddress1"><div class="radio"><label><input type="radio" name="copyAddressFromRight" class="accountAddress" data-copy-address="billing" checked="checked">&nbsp;<?php echo vtranslate('LBL_ACCOUNTS_ADDRESS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?><input type="radio" name="copyAddressFromRight" class="contactAddress" data-copy-address="billing" checked="checked">&nbsp;<?php echo vtranslate('LBL_CONTACTS_ADDRESS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</label></td><td class="fieldValue" name="copyAddress2"><div class="radio"><label><input type="radio" name="copyAddressFromLeft" class="accountAddress" data-copy-address="shipping" checked="checked">&nbsp;<?php echo vtranslate('LBL_ACCOUNTS_ADDRESS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?><input type="radio" name="copyAddressFromLeft" class="contactAddress" data-copy-address="shipping" checked="checked">&nbsp;<?php echo vtranslate('LBL_CONTACTS_ADDRESS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</option><?php } ?></select><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]&&$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]['customLabel']){?><?php $_template = new Smarty_Internal_Template('eval:'.$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]['customLabel'], $_smarty_tpl->smarty, $_smarty_tpl);echo $_template->fetch(); ?><?php }else{ ?><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['MODULE']->value);?>
<?php }?><?php }?><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]&&$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]['customLabel']){?><?php $_template = new Smarty_Internal_Template('eval:'.$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]['customLabel'], $_smarty_tpl->smarty, $_smarty_tpl);echo $_template->fetch(); ?><?php }else{ ?><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['MODULE']->value);?>
<?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()==true){?>&nbsp;<span class="redColor">*</span><?php }?>&nbsp;&nbsp;</td><td class="fieldValue <?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name');?>
...
</div><?php }?><?php if ($_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]&&$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]['customTemplate']){?><?php $_template = new Smarty_Internal_Template('eval:'.$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]['customTemplate'], $_smarty_tpl->smarty, $_smarty_tpl);echo $_template->fetch(); ?><?php }else{ ?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getUITypeModel()->getTemplateName(),$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }?></td><?php }?><?php } ?><?php if ((1 & $_smarty_tpl->tpl_vars['COUNTER']->value)){?><td></td><td></td><?php }?></tr></table></div><?php }?><?php } ?></div><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("partials/LineItemsEdit.tpl",'Inventory'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }} ?>