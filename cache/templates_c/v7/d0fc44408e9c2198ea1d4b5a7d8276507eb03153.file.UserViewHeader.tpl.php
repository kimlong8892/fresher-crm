<?php /* Smarty version Smarty-3.1.7, created on 2021-01-23 09:23:03
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Users/UserViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2076668941600b888749e6a6-00153169%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd0fc44408e9c2198ea1d4b5a7d8276507eb03153' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Users/UserViewHeader.tpl',
      1 => 1585899536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2076668941600b888749e6a6-00153169',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_600b88875e759',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_600b88875e759')) {function content_600b88875e759($_smarty_tpl) {?>



<?php if ($_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['form']&&$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['form']['hiddenFields']!=null){?><?php $_template = new Smarty_Internal_Template('eval:'.$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['form']['hiddenFields'], $_smarty_tpl->smarty, $_smarty_tpl);echo $_template->fetch(); ?><?php }?><?php if ($_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['scripts']!=null){?><?php $_template = new Smarty_Internal_Template('eval:'.$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['scripts'], $_smarty_tpl->smarty, $_smarty_tpl);echo $_template->fetch(); ?><?php }?><div class="detailViewContainer"><div class="col-sm-12 col-xs-12"><div class="detailViewTitle" id="userPageHeader"><div class = "row"><div class="col-md-5"><div class="col-md-5 recordImage" style="height: 50px;width: 50px;"><?php $_smarty_tpl->tpl_vars['NOIMAGE'] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['IMAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = false;
