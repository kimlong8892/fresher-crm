<?php /* Smarty version Smarty-3.1.7, created on 2020-12-23 15:33:18
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Vtiger/QuickCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:536900625fe300cea1f0c5-78778658%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '08b1195239d89a2dae1ea272980ba01f95bb4f1c' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Vtiger/QuickCreate.tpl',
      1 => 1585899536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '536900625fe300cea1f0c5-78778658',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fe300cebc66d',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fe300cebc66d')) {function content_5fe300cebc66d($_smarty_tpl) {?>
...
"></script><?php } ?><?php if ($_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['form']&&$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['form']['hiddenFields']){?><?php $_template = new Smarty_Internal_Template('eval:'.$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['form']['hiddenFields'], $_smarty_tpl->smarty, $_smarty_tpl);echo $_template->fetch(); ?><?php }?><?php if ($_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['scripts']!=null){?><?php $_template = new Smarty_Internal_Template('eval:'.$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['scripts'], $_smarty_tpl->smarty, $_smarty_tpl);echo $_template->fetch(); ?><?php }?><div class="modal-dialog modal-lg"><div class="modal-content"><form class="form-horizontal recordEditView" id="QuickCreate" name="QuickCreate" method="post" action="index.php"><?php ob_start();?><?php echo vtranslate('LBL_QUICK_CREATE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
&nbsp;<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()==true){?> <span class="redColor">*</span> <?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['isReferenceField']->value!="reference"){?></label><?php }?></td><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!='83'){?><td class="fieldValue <?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
 col-lg-4" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='19'){?> colspan="3" <?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?> <?php }?>> <?php if ($_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]&&$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]['customTemplate']){?><?php $_template = new Smarty_Internal_Template('eval:'.$_smarty_tpl->tpl_vars['DISPLAY_PARAMS']->value['fields'][$_smarty_tpl->tpl_vars['FIELD_NAME']->value]['customTemplate'], $_smarty_tpl->smarty, $_smarty_tpl);echo $_template->fetch(); ?><?php }else{ ?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getUITypeModel()->getTemplateName(),$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }?></td><?php }?><?php } ?></tr></table></div></div><div class="modal-footer"><center><?php if ($_smarty_tpl->tpl_vars['BUTTON_NAME']->value!=null){?><?php $_smarty_tpl->tpl_vars['BUTTON_LABEL'] = new Smarty_variable($_smarty_tpl->tpl_vars['BUTTON_NAME']->value, null, 0);?><?php }else{ ?><?php ob_start();?><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
