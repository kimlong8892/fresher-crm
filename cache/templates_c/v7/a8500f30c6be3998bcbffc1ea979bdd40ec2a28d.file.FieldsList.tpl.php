<?php /* Smarty version Smarty-3.1.7, created on 2020-12-23 15:33:49
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Settings/LayoutEditor/FieldsList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16847758255fe300ed8d9421-59377196%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a8500f30c6be3998bcbffc1ea979bdd40ec2a28d' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Settings/LayoutEditor/FieldsList.tpl',
      1 => 1585899536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16847758255fe300ed8d9421-59377196',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fe300ede41cd',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fe300ede41cd')) {function content_5fe300ede41cd($_smarty_tpl) {?>

<?php $_smarty_tpl->tpl_vars['IS_SORTABLE'] = new Smarty_variable($_smarty_tpl->tpl_vars['SELECTED_MODULE_MODEL']->value->isSortableAllowed(), null, 0);?><?php $_smarty_tpl->tpl_vars['ALL_BLOCK_LABELS'] = new Smarty_variable(array(), null, 0);?><div id="btnEditBlockTemplate" style="display: none"><a href="javascript:void(0)" class="btnEditBlock" style="margin-left: 5px" title="<?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"><i class="fa fa-pencil"></i></a></div><div id="btnHideFieldTemplate" style="display: none"><a href="javascript:void(0)" class="btnHideField" style="margin-left: 5px" title="<?php echo vtranslate('LBL_HIDE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"><i class="fa fa-eye-slash"></i></a></div><div class="row fieldsListContainer" style="padding:1% 0"><?php if (isDeveloperMode()){?><div class="col-sm-6"><button class="btn btn-primary addCustomBlock" type="button"><i class="fa fa-plus"></i>&nbsp;<?php echo vtranslate('LBL_ADD_CUSTOM_BLOCK',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button>&nbsp;<?php if ($_smarty_tpl->tpl_vars['SELECTED_TAB']->value=='detailViewTab'){?><button class="btn btn-primary copyLayoutFromEditView" type="button"><i class="fa fa-clone"></i>&nbsp;<?php echo vtranslate('LBL_COPY_LAYOUT_FROM_EDITVIEW',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button><?php }?></div><?php }?><div class="col-sm-6"><?php if ($_smarty_tpl->tpl_vars['IS_SORTABLE']->value){?><span class="pull-right"><button class="btn btn-success saveFieldSequence" type="button" style="opacity:0;margin-right:0px;"><?php echo vtranslate('LBL_SAVE_LAYOUT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
" style="background: white;"data-label-display-en="<?php echo $_smarty_tpl->tpl_vars['BLOCK_MODEL']->value->labelDisplayEn;?>
" data-label-display-vn="<?php echo $_smarty_tpl->tpl_vars['BLOCK_MODEL']->value->labelDisplayVn;?>
"data-custom-fields-count="<?php echo $_smarty_tpl->tpl_vars['BLOCK_MODEL']->value->getCustomFieldsCount();?>
...
" />&nbsp;&nbsp;<?php }?><strong class="translatedBlockLabel" data-label-key="<?php echo $_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value;?>
"><?php echo vtranslate($_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value,$_smarty_tpl->tpl_vars['SELECTED_MODULE_NAME']->value);?>
</strong></div><div class="col-sm-9 padding10 marginLeftZero"><div class="blockActions" style="float:right !important;"><?php if ($_smarty_tpl->tpl_vars['SELECTED_TAB']->value=='detailViewTab'){?><span><i class="fa fa-info-circle" title="<?php echo vtranslate('LBL_COLLAPSE_BLOCK_DETAIL_VIEW',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
"/></span>&nbsp;<?php }?><?php if (isDeveloperMode()&&$_smarty_tpl->tpl_vars['BLOCK_MODEL']->value->isAddCustomFieldEnabled()&&$_smarty_tpl->tpl_vars['SELECTED_TAB']->value=='editViewTab'){?><button class="btn btn-default addButton btn-sm addCustomField" type="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_CUSTOM_FIELD',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
"></i></a><?php }?></span></div></div></div></li><?php }?><?php } ?><?php if (count($_smarty_tpl->tpl_vars['FIELDS_LIST']->value)%2==0){?><?php if (isDeveloperMode()&&$_smarty_tpl->tpl_vars['BLOCK_MODEL']->value->isAddCustomFieldEnabled()&&$_smarty_tpl->tpl_vars['SELECTED_TAB']->value=='editViewTab'){?><li class="row dummyRow"><span class="dragUiText col-sm-8"><?php echo vtranslate('LBL_ADD_NEW_FIELD_HERE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
" />&nbsp;&nbsp;</div><div class="col-sm-9 padding10 marginLeftZero"><div class="blockActions" style="float: right !important;"><?php if ($_smarty_tpl->tpl_vars['SELECTED_TAB']->value=='detailViewTab'){?><span><i class="fa fa-info-circle" title="<?php echo vtranslate('LBL_COLLAPSE_BLOCK_DETAIL_VIEW',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"></i>&nbsp; <?php echo vtranslate('LBL_COLLAPSE_BLOCK',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
" data-off-text="<?php echo vtranslate('LBL_NO',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
" data-on-color="primary" data-block-id="<?php echo $_smarty_tpl->tpl_vars['BLOCK_MODEL']->value->get('id');?>
"/></span>&nbsp;<?php }?><?php if (isDeveloperMode()&&$_smarty_tpl->tpl_vars['SELECTED_TAB']->value=='editViewTab'){?><button class="btn btn-default addButton addCustomField" type="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_CUSTOM_FIELD',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button>&nbsp;<?php }?>&nbsp;<button class="inActiveFields addButton btn btn-default btn-sm"><?php echo vtranslate('LBL_SHOW_HIDDEN_FIELDS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</button></div></div></div><div class="blockFieldsList row blockFieldsSortable"><?php if (isDeveloperMode()){?><ul class="connectedSortable col-sm-6 ui-sortable"name="sortable1"><li class="row dummyRow"><span class="dragUiText col-sm-8"><?php echo vtranslate('LBL_ADD_NEW_FIELD_HERE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span><span class="col-sm-4" style="margin-top: 7%;margin-left: -15%;"><button class="btn btn-default btn-sm addButton"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button></span></li></ul><?php }?><ul class="connectedSortable col-sm-6 ui-sortable" name="sortable2"></ul></div></div><li class="newCustomFieldCopy hide"><div class="row border1px"><div class="col-sm-4"><div class="marginLeftZero" data-field-id="" data-sequence=""><div class="row"><span class="col-sm-1">&nbsp;<?php if ($_smarty_tpl->tpl_vars['IS_SORTABLE']->value){?><img src="<?php echo vimage_path('drag.png');?>
...
<form class="form-horizontal addCustomBlockForm"><div class="modal-body"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('BlockFormFields.tpl',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<div class="form-group"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_ADD_AFTER',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</form></div><div class="modal-dialog modal-content editBlockModal hide"><?php ob_start();?><?php echo vtranslate('LBL_EDIT_BLOCK',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<?php $_tmp12=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['HEADER_TITLE'] = new Smarty_variable($_tmp12, null, 0);?> <?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("ModalHeader.tpl",$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('TITLE'=>$_smarty_tpl->tpl_vars['HEADER_TITLE']->value), 0);?>
<form class="form-horizontal editBlockForm"><input type="hidden" name="blockid"/><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('BlockFormFields.tpl',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
