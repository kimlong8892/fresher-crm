<?php /* Smarty version Smarty-3.1.7, created on 2021-01-14 08:48:35
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/EmailTemplates/partials/EditViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4310807975fffa2f36b2d02-37123585%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6df20c89564113b407d6d23c9e33b3c1187e2cdb' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/EmailTemplates/partials/EditViewContents.tpl',
      1 => 1593395090,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4310807975fffa2f36b2d02-37123585',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fffa2f378ddd',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fffa2f378ddd')) {function content_5fffa2f378ddd($_smarty_tpl) {?>
...
' /><?php }?><div name='editContent'><div class='fieldBlockContainer'><span><h4 class='fieldBlockHeader'><?php echo vtranslate('LBL_OVERVIEW',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"><?php if ($_smarty_tpl->tpl_vars['IS_SYSTEM_TEMPLATE_EDIT']->value){?><span><?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('templatename');?>
</span><?php }?><input id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_editView_fieldName_templatename" type="text" class="inputElement <?php if ($_smarty_tpl->tpl_vars['IS_SYSTEM_TEMPLATE_EDIT']->value){?> hide <?php }?>" data-rule-required="true" name="templatename" value="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('templatename');?>
