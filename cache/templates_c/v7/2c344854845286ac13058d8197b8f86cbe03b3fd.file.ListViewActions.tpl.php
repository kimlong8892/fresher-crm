<?php /* Smarty version Smarty-3.1.7, created on 2021-01-26 10:09:36
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1530533382600f87f071c3e0-54989225%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2c344854845286ac13058d8197b8f86cbe03b3fd' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewActions.tpl',
      1 => 1585899536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1530533382600f87f071c3e0-54989225',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_600f87f08df2e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_600f87f08df2e')) {function content_600f87f08df2e($_smarty_tpl) {?>
...
</a></li><?php }?><?php }?><?php } ?></ul></div><?php }?></div></div><div class='col-md-6'><?php if ($_SESSION['lvs'][$_smarty_tpl->tpl_vars['MODULE']->value]['viewname']){?><?php $_smarty_tpl->tpl_vars['VIEWID'] = new Smarty_variable($_SESSION['lvs'][$_smarty_tpl->tpl_vars['MODULE']->value]['viewname'], null, 0);?><?php }?><?php if ($_smarty_tpl->tpl_vars['VIEWID']->value){?><?php  $_smarty_tpl->tpl_vars['FILTER_TYPES'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FILTER_TYPES']->_loop = false;
...
?><?php if ($_smarty_tpl->tpl_vars['FILTERS']->value->get('cvid')==$_smarty_tpl->tpl_vars['VIEWID']->value){?><?php $_smarty_tpl->tpl_vars['CVNAME'] = new Smarty_variable($_smarty_tpl->tpl_vars['FILTERS']->value->get('viewname'), null, 0);?><?php break 1?><?php }?><?php } ?><?php } ?><?php $_smarty_tpl->tpl_vars['DEFAULT_FILTER_URL'] = new Smarty_variable($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getDefaultUrl(), null, 0);?><?php $_smarty_tpl->tpl_vars['DEFAULT_FILTER_ID'] = new Smarty_variable($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getDefaultCustomFilter(), null, 0);?><?php if ($_smarty_tpl->tpl_vars['DEFAULT_FILTER_ID']->value){?><?php $_smarty_tpl->tpl_vars['DEFAULT_FILTER_URL'] = new Smarty_variable((($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getListViewUrl()).("&viewname=")).($_smarty_tpl->tpl_vars['DEFAULT_FILTER_ID']->value), null, 0);?><?php }?><?php if ($_smarty_tpl->tpl_vars['CVNAME']->value=='All'&&$_smarty_tpl->tpl_vars['CURRENT_TAG']->value!=''){?><?php $_smarty_tpl->tpl_vars['replaceParams'] = new Smarty_variable(array('%module_name'=>vtranslate($_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['MODULE']->value),'%tag_name'=>$_smarty_tpl->tpl_vars['TAGS']->value[$_smarty_tpl->tpl_vars['CURRENT_TAG']->value]->getName()), null, 0);?><div class="current-filter-message"><?php echo vtranslate('LBL_DISPLAYING_RESULTS_TAG',$_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['replaceParams']->value);?>
.</div><?php }elseif($_smarty_tpl->tpl_vars['CVNAME']->value=='All'){?><?php $_smarty_tpl->tpl_vars['replaceParams'] = new Smarty_variable(array('%module_name'=>vtranslate($_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['MODULE']->value)), null, 0);?><div class="current-filter-message"><?php echo vtranslate('LBL_DISPLAYING_RESULTS_ALL',$_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['replaceParams']->value);?>
.</div><?php }else{ ?><?php $_smarty_tpl->tpl_vars['replaceParams'] = new Smarty_variable(array('%module_name'=>vtranslate($_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['MODULE']->value),'%filter_name'=>vtranslate($_smarty_tpl->tpl_vars['CVNAME']->value,$_smarty_tpl->tpl_vars['MODULE']->value)), null, 0);?><div class="current-filter-message"><?php echo vtranslate('LBL_DISPLAYING_RESULTS_FILTER',$_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['replaceParams']->value);?>
.</div><?php }?><?php }?><div class="hide messageContainer" style = "height:30px;"><center><a href="#" id="selectAllMsgDiv" data-message="<?php echo vtranslate('LBL_SELECTED_ALL_MESSAGE');?>
