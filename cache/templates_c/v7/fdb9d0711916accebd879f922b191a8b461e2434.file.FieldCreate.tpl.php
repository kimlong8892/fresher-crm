<?php /* Smarty version Smarty-3.1.7, created on 2020-12-23 15:33:50
         compiled from "/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Settings/LayoutEditor/FieldCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20688458085fe300ee2f1005-63573316%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fdb9d0711916accebd879f922b191a8b461e2434' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Settings/LayoutEditor/FieldCreate.tpl',
      1 => 1585899536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20688458085fe300ee2f1005-63573316',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fe300ee455ae',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fe300ee455ae')) {function content_5fe300ee455ae($_smarty_tpl) {?>
...
</option><?php } ?></select></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_FIELD_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;<span class="redColor">*</span></label><div class="controls col-sm-7"><input type="text" class='inputElement col-sm-9' maxlength="50" <?php if ($_smarty_tpl->tpl_vars['IS_FIELD_EDIT_MODE']->value){?>disabled="disabled"<?php }?> name="fieldName" value="<?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name'),$_smarty_tpl->tpl_vars['SELECTED_MODULE_NAME']->value);?>
" data-rule-required='true' style='width: 75%' /></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_FIELD_LABEL_KEY_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
 &nbsp;<span class="redColor">*</span></label><div class="controls col-sm-7"><input type="text" class='inputElement col-sm-9' maxlength="50" name="fieldLabel" value="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label');?>
" data-rule-required='true' style='width: 75%' <?php if ($_smarty_tpl->tpl_vars['IS_FIELD_EDIT_MODE']->value){?>readonly<?php }?>/></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_FIELD_LABEL_DISPLAY_NAME_VN',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
 &nbsp;<span class="redColor">*</span></label><div class="controls col-sm-7"><input type="text" class='inputElement col-sm-9' name="fieldLabelDisplayVn" value="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->labelDisplayVn;?>
" data-rule-required='true' style='width: 75%' /></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_FIELD_LABEL_DISPLAY_NAME_EN',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
 &nbsp;<span class="redColor">*</span></label><div class="controls col-sm-7"><input type="text" class='inputElement col-sm-9' name="fieldLabelDisplayEn" value="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->labelDisplayEn;?>
