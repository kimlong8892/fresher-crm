...
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3743c6cc5cf7353b7aeb75347fc632d253f6b7a5' => 
    array (
      0 => '/var/www/html/crm-fresher/includes/runtime/../../layouts/v7/modules/Leads/ConvertLead.tpl',
      1 => 1585899536,
      2 => 'file',
    ),
  ),
...
"><input type="hidden" name="main_owner_id" value="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('main_owner_id');?>
...
?><div class="row"><div class="fieldLabel <?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName();?>
 col-lg-4"> <label class='muted pull-right'><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
&nbsp;<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()==true){?> <span class="redColor">*</span> <?php }?></label></div><div class="fieldValue <?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName();?>
 col-lg-8"> <?php echo $_smarty_tpl->getSubTemplate (vtemplate_path($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getUITypeModel()->getTemplateName()), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</div></div><br><?php } ?></div></div></div><div class="col-lg-1"></div></div><br><?php } ?><div class="defaultFields"><div class="row"><div class="col-lg-1"></div><div class="col-lg-10" style="border:1px solid #CCC;"><div style="margin-top:20px;margin-bottom: 20px;"><div class="row"><?php $_smarty_tpl->tpl_vars['FIELD_MODEL'] = new Smarty_variable($_smarty_tpl->tpl_vars['ASSIGN_TO']->value, null, 0);?><div class="fieldLabel <?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName();?>
 col-lg-4"> <label class='muted pull-right'><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
&nbsp;<span class="redColor">*</span></label></div><div class="fieldValue <?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName();?>
 col-lg-8"> <?php echo $_smarty_tpl->getSubTemplate (vtemplate_path($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getUITypeModel()->getTemplateName(),$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</div></div><br><div class="row"><div class="fieldLabel <?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName();?>
 col-lg-4"> <label class='muted pull-right'><?php echo vtranslate('LBL_TRANSFER_RELATED_RECORD',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></div><div class="fieldValue <?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName();?>
 col-lg-8"> <?php  $_smarty_tpl->tpl_vars['MODULE_FIELD_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['MODULE_FIELD_MODEL']->_loop = false;
 $_smarty_tpl->tpl_vars['MODULE_NAME'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['CONVERT_LEAD_FIELDS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['MODULE_FIELD_MODEL']->key => $_smarty_tpl->tpl_vars['MODULE_FIELD_MODEL']->value){
$_smarty_tpl->tpl_vars['MODULE_FIELD_MODEL']->_loop = true;
